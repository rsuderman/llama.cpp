...
typedef struct ggml_hrx_loom_jit_source_t {
  const void* source_data;
  size_t source_size;
  ggml_hrx_loom_jit_source_format_t source_format;
  const char* source_identifier;
} ggml_hrx_loom_jit_source_t;
...
typedef struct ggml_hrx_loom_jit_compile_result_t {
  ...
  char* final_module_text;
  size_t final_module_text_size;
